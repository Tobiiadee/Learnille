...
export default function Performance() {
  ...
  return (
    <Card>
      <section className='w-full flex flex-col gap-3 items-center text-xs font-normal h-full'>
        <div className='flex justify-between w-full'>
          ...
          <div className='relative'>
            ...
            {viewMonths && <Month show={setViewMonths} className="absolute -bottom-[8rem] tab:-bottom-[6rem] right-[1px]"/>}
          </div>
        </div>
