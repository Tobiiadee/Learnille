...
export default function TagOne() {
  return (
    <section className='w-full px-4 tab:px-0 grid  tab:grid-cols-2 nb:grid-cols-3 gap-2 mt-10 tab:mt-0 tab:pr-1'>
      <Card classNames='flex items-center gap-6 tab:gap-4 w-full '>
