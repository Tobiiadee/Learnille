  ...
  return (
    <section className='overflow-hidden'>
      ...
      <AnimatePresence>
        {openHistory && (
          <motion.main
            initial={{ y: openHistory ? -500 : 0 }}
            animate={{ y: 1 }}
            exit={{ y: -500, height: "3rem" }}
            transition={{ duration: 0.3 }}
            className='bg-white flex flex-col nb:flex-row gap-8 overflow-hidden px-4 py-2 border-t pt-4 shadow-lg pb-4 '>
