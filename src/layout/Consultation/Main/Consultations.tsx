...
import Consultation_Home from "../Consultant_Pages/Consultation_Home";
import Consultation_Tips_List from "../Consultant_Pages/Tips/Consultation_Tips_List";
import { useParams } from "react-router-dom";
import Consultation_Metting from "../Consultant_Pages/Consultation_Meeting/Consultation_Metting";
...
export default function Consultations() {
  ...
  switch (consultation_id) {
    case "consultation_meeting":
      consultationPage = <Consultation_Metting />;
      break;
