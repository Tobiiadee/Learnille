...
import MyCourse_SectionContent from "./MyCourse_SectionContent";

import { ArrowD } from "@/assets/svg/HeaderSVG";
// import { SubSectionType } from "@/lib/types/course_tyeps";

// type CourseSectType = CourseSectionType & {
//   section: SubSectionType[];
// };

export default function MyCourse_SectionItem() {
      ...
      <div className={`-mt-4`}>
        <section
          ...
          <div className='flex items-center gap-[0.2rem]'>
            ...
            <h2 className='font-bold mb-1 text-layout-bg'>{""}</h2>
          </div>
