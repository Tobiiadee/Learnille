...
export default function NavBar({ onView }: ViewType) {
  return (
    <nav onClick={onView} className='fixed top-0 left-0 w-72 z-30 bg-layout-bg rounded-r-lg h-screen py-4 flex flex-col'>
      ...
      <section className='flex justify-around items-center border-t border-dotted pt-8 text-sm text-white w-full mt-28'>
