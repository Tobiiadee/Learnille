...
import Course_Section_Content, { CourseSectionType } from "./Course_Section_Content";

import { ArrowD } from "@/assets/svg/HeaderSVG";
import Course_Content_File from "./Course_Content_File";

export default function Course_Section({curriculum}: CourseSectionType) {
    ...
    <>
      <div className={`-mt-4`}>
        <section
          ...
          className={`text-[10px] flex items-center justify-between p-1 ${openContent ? "border-[0.5px] border-layout-bg" : "border-b"}   cursor-pointer`}>
          ...
          <div className='flex gap-1 text-text'>
            ...
            {!curriculum && <span className='flex items-center gap-1'>
              <svg
                width='18px'
                height='18px'
                viewBox='0 -0.5 25 25'
        ...
        {openContent && (
          <section className='mt-1 flex flex-col'>
            <Course_Section_Content curriculum={curriculum}/>
            <Course_Section_Content curriculum={curriculum}/>
            <Course_Content_File />
            <Course_Section_Content curriculum={curriculum}/>
            <Course_Section_Content curriculum={curriculum}/>
