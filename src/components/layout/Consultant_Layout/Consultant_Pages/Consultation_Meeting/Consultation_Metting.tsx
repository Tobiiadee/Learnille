      ...
      <main className='grid grid-cols-3 gap-4'>
        <section className='col-span-3 tab:col-span-2'>
          <div className=''>
            ...
            <div className='relative -z-10 mt-1 w-full border h-max tab:h-[26rem] shadow rounded-lg overflow-hidden'>
              <img src={img} alt='' />
        ...
        <section className='flex flex-col col-span-3 tab:col-span-1  gap-4'>
          ...
          <Card>
            <section>
              <h2 className="text-sm font-semibold text-black border-b pb-2">Conversations (<span>40</span>)</h2>
            </section>
          </Card>
        </section>
      </main>
